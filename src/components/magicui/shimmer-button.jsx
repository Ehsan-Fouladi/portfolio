...
export const ShimmerButton = React.forwardRef((
  ...
  return (
    <button
      ...
      className={cn(
        "group relative z-0 flex cursor-pointer items-center justify-center overflow-hidden whitespace-nowrap px-6 py-3 text-white [border-radius:var(--radius)]",
      ...
      <div
        className={cn(
          ...
          "rounded-lg px-6 py-3 text-sm font-medium shadow-[inset_0_-8px_10px_#ffffff1f]",
          // transition
